...
### Партиционирование
Таблица History будет партиционироваться по дате создания сущностей (т. е. 30 партиций). Это позволит обеспечить более эффективную и быструю работу с нужными данными, поскольку увеличится вероятность попадания их в память и кэш.
