...
Для обеспечения надежности в расчетах будем учитывать возможность отключения датацентров и брать требуемую нагрузку в 4 раза больше вычисленной на датацентр.
...
|---	|---	|---	|
| Authentication 	| 183 / 3 * 4 = 244 	| 0.072 / 3 * 4 = 0.1 	|
| Music listening 	| 161361 / 49 * 2 = 6586 	| 5809 / 49 * 2 = 237 	|
| Profile 	| (182 + 3) / 3 * 4 = 247 	| 1.1 / 3 * 4 = 1.5 	|
| Artist 	| 363 / 3 * 4 = 484 	| 2.2 / 3 * 4 = 2.93 	|
| Playlists 	| (15 + 363) / 3 * 4 = 504 	| (0.006 + 0.05) / 3 * 4 = 0.075 	|
| Search 	| 727 / 3 * 4 = 970 	| 26.17 / 3 * 4 = 34.9 	|
| Recommendations 	| (15.7 млн ÷ 86400) / 3 * 4 = 243 	| (15.7 млн * 250 КБ / 86400 * 3) / 3 * 4 = 1.4 	|
...
|---	|---	|---	|---	|---	|
| Music listening 	| 13172 	| средняя 	| 275 	| 28 	|
| Authentication 	| 244 	| легкая 	| 3 	| 1 	|
| Profile 	| 247 	| средняя 	| 5 	| 1 	|
| Artist 	| 484 	| легкая 	| 5 	| 1 	|
| Playlists 	| 504 	| средняя 	| 11 	| 2 	|
| Search 	| 970 	| тяжелая 	| 40 	| 4 	|
| Recommendations 	| 243 	| тяжелая 	| 10 	| 1 	|
| API-Gateway 	| 15864 	| легкая 	| 159   | 16    |
| Nginx 	| 15864 	| SSL-handshake 	| 24 * 2   | 32    |

**Итого**: на 1 ДЦ с развернутыми в Kubernetes сервисами нужно выделять 556 ядер CPU и 86 ГБ RAM.
...
| Сервис 	| Конфигурация 	| Ядра 	| На 1 ДЦ 	| Покупка 1 	| Аренда 1 	|
|---	|---	|---	|---	|---	|---	|
| Kubenode 	| 2x6554S/2x16Gb/1xNVMe512Gb/2x25Gb/s 	| 72 	| 3 	| $11260.6 	| $37551.5 	|
| Cassandra + Redis 	| 6326/3x32Gb/4xNVMe30Tb/2x25Gb/s 	| 16 	| 2 	| $28395.5 	| $2150.6 	|
