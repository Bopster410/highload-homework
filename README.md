...
Для выбора локаций датацентров будем учитывать данные о распределении пользователей сервиса по странам[^8], общее распределение трафика по различным частям света (п. 1), расположение подводных кабелей[^9], электростанций[^10] и плотности населения.

| Регион 	| Название (страна и город) 	| Обоснование выбора 	|
|---	|---	|---	|
| Северная Америка 	| Digital Reality - NYC1 (Нью-Йорк, США) 	| сертифицированный Tier-4 датацентр;<br>вблизи нескольких электростанций;<br>вблизи нескольких подводных кабелей, связывающих Северную Америку с Южной и Европой;<br>в США проходит наибольший трафик Spotify (~25%) 	|
| Латинская Америка 	| Ascenty - Vinhedo 1 (Сан-Паулу, Бразилия) 	| сертифицированный Tier-4 датацентр;<br>вблизи электростанций;<br>вблизи подводных кабелей, связывающих Латинскую Америку с Северной;<br>большой трафик Spotify (~5%) 	|
| Европа 	| Shield House (Глостер, Великобритания) 	| сертифицированный Tier-3 датацентр;<br>вблизи электростанций;<br>вблизи большого числа подводных кабелей, соединяющих Великобританию почти со всем миром 	|
...
[^10]: [Power Plants Map](https://database.earth/energy/power-plants)
