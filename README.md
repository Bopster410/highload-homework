...
![image](https://github.com/user-attachments/assets/aa3e4f99-dd34-466d-898c-8d1d81848559)
| Таблица       	|             Требования конситентности             	|                 Размеры данных (Гб)                 	|
|---------------	|:-------------------------------------------------:	|:---------------------------------------------------:	|
| User          	| id - PK email - уникальный  username - уникальный 	|        (8 + 64 + 64 + 128) * 626 млн = 165.3        	|
| Profile       	|                      id - PK                      	|   (8 + 1 + 3 + 64 + 255 + 4 + 4) * 626 млн = 212.2  	|
| Session       	|             user_id и session_id - PK             	|              (8 + 64) * 15.7 млн = 1.1              	|
| Music         	|                      id - PK                      	| (8 + 64 + 2 + 255 + 8 + 8 + 4 + 4) * 108 млн = 38.1 	|
| Album         	|                      id - PK                      	|     (8 + 64 + 255 + 8 + 4 + 4) * 4 * 8 млн = 11     	|
| Artist        	|                      id - PK                      	|      (8 + 64 + 255 + 128 + 4 + 4) * 8 млн = 3.7     	|
| Genre         	|                      id - PK                      	|              (8 + 64) * 5000 = 0.00036              	|
| Playlist      	|                      id - PK                      	|    (8 + 64 + 255 + 8 + 1 + 4 + 4) * 8 млрд = 2752   	|
| PlaylistMusic 	|            playlist_id и music_id - PK            	|             (8 + 8) * 50 * 8 млрд = 6400            	|
| FavoriteMusic 	|              user_id и music_id - PK              	|            (8 + 8) * 500 * 626 млн = 5008           	|
