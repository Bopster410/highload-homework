...
| Африка, Центральная Азия 	| STT Mumbai DC3 (Мумбаи, Индия) 	| Tier-3 датацентр;<br>вблизи большого числа подводных кабелей, связывающих Индию с островами Океании и Австралией;<br>большой трафик через Индию (3.77%)	|
...
Межсервисная балансировка будет обеспечиваться при помощи sidecar proxy, поскольку он позволит добиться меньшей задержки, чем другие способы.
