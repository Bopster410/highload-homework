...
* профили изменяются 100 тыс. раз в день;
* каждый пользователь запрашивает информацию об альбоме в среднем 3 раза за день;
* каждый пользователь запрашивает информацию об исполнителе в среднем 2 раза за день;
* жанры запрашиваются 150 тыс. раз в день;
* каждый пользователь запрашивает информацию о плейлисте в среднем 2 раза за день;
* каждый пользователь слушает в среднем 8 песен из плейлистов;
* каждый пользователь слушает в среднем 18 песен из избранного;
* каждый пользователь слушает в среднем 3 песни из недельной подборки;
* каждый пользователь слушает в среднем 10 песен из дневной подборки;
* каждый пользователь слушает в среднем 1 песню из своей истории.
...
## 9. Схема проекта
![highload_10](https://github.com/user-attachments/assets/a6eeddbc-ab3b-488f-b0cc-89c302444f3f)
