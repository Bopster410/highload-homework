...
|---	|:---:	|:---:	|:---:	|:---:	|
| Прослушивание музыки 	| 15.7&nbsp;млн × 148 × 60&nbsp;с × 150&nbsp;Кбит/c = 20&nbsp;912&nbsp;400 	| 1936.3 	| 5 809 	| 15.7&nbsp;млн × 148 × 6* ÷ 86&nbsp;400 = 161&nbsp;361 	|
| Поиск 	| 62.8&nbsp;млн × 1.5&nbsp;МБ** = 94&nbsp;200 	| 8.72 	| 26.17 	| 727 	|
| Создание плейлиста 	| 1.3&nbsp;млн × 20&nbsp;КБ*** = 26 	| 0.0024 	| 0.006 	| 15 	|
| Добавление/удаление из плейлиста 	| 31.4&nbsp;млн × 5.2&nbsp;КБ**** = 163.3 	| 0.015 	| 0.05 	| 363 	|
| Регистрация/авторизация 	| 15.83&nbsp;млн × 16&nbsp;КБ***** = 253.3 	| 0.024 	| 0.072 	| 183 	|

> \* запрос данных песни происходит каждые 10 секунд или 6 раз в минуту  
> \*\* средний трафик при поиске  
> \*\*\* средний трафик при создании плейлиста  
> \*\*\*\* средний трафик при добавлении/удалении песни из плейлиста  
> \*\*\*\*\* средний трафик при регистрации/авторизации песни из плейлиста  
> _(все приведенные данные получены в ходе эксперимента и ручного замера)_
